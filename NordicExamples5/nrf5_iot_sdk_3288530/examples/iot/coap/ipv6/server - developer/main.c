...
static const ipv6_addr_t      local_routers_multicast_addr = {{0xFE, 0x80, 0x00, 0x00, \
                                                               0x00, 0x00, 0x00, 0x00, \
                                                               0x02, 0x11, 0x64, 0xFF, \
                                                               0xFE, 0xA5, 0x85, 0x42}};      /**< Multicast address of all routers on the local network segment. */
...
//
//KODEN SOM FÅR LYSENE TIL Å BLINKE VED TILKOBLING *******************************************************************************************************************
//
...
{
		if (button_action == ARR_BUTTON_PUSH){
				switch(pin_no)
				{
					case BUTTON_1:
							nrf_gpio_toggle(LED_1);
							break;
					case BUTTON_2:
							nrf_gpio_toggle(LED_2);
							break;
					case BUTTON_3:
							nrf_gpio_toggle(LED_3);
							break;
					case BUTTON_4:
							nrf_gpio_toggle(LED_4);
							break;
					default: 
							break;
				}
...
{
		button_handler(pin_no, button_action); // Sindre
#ifdef COMMISSIONING_ENABLED
