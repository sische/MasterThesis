...
#define DEVICE_NAME                      "CoAP_SRV_new52"                           /**< Device name used in BLE undirected advertisement. */
...
#define CONFIG_MODE_DEVICE_NAME           "CoAP_SRV_new52"                           /**< Name of device. Will be included in the advertising data. */
