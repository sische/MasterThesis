...
{
    name=payload,
    description={The part of the transmitted data that is the intended message. How much of the total packet that is the payload is denoted \textit{goodput} in this thesis}
}

\newglossaryentry{throughput}
{
	name=throughput,
	description={The total amount of data sent one way though the network. The sum of payload and additional header files needed to transport the packet}
}
