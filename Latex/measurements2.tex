...
As a summary of this chapter, the pros and cons will be directly compared to get a more clear understanding of the discoveries that has been made. 
...
\begin{tabular}{ccccl}
\cline{1-4}
\multicolumn{1}{|c|}{\textbf{Case}}                                                                                       & \multicolumn{1}{c|}{\textbf{CON}} & \multicolumn{1}{c|}{\textbf{NON}} & \multicolumn{1}{c|}{\textbf{Comments}}                                                                                      &  \\ \cline{1-4}
\multicolumn{1}{|c|}{Need of ACKs}                                                                                        & \multicolumn{1}{c|}{Yes}          & \multicolumn{1}{c|}{No}           & \multicolumn{1}{c|}{\begin{tabular}[c]{@{}c@{}}Accational connection \\ test at 16+7+7 bytes\\  in both cases\end{tabular}} &  \\ \cline{1-4}
\multicolumn{1}{|c|}{\begin{tabular}[c]{@{}c@{}}Minimum number of \\ bytes needed for \\ empty CoAP message\end{tabular}} & \multicolumn{1}{c|}{74+104}       & \multicolumn{1}{c|}{76}           & \multicolumn{1}{c|}{}                                                                                                       &  \\ \cline{1-4}
\multicolumn{1}{|c|}{\begin{tabular}[c]{@{}c@{}}Fastest for payload \\ \textless 500 byte\end{tabular}}                   & \multicolumn{1}{c|}{X}            & \multicolumn{1}{c|}{}             & \multicolumn{1}{c|}{\begin{tabular}[c]{@{}c@{}}Almost 3x faster\\ payload \textless 10 byte\end{tabular}}                   &  \\ \cline{1-4}
\multicolumn{1}{|c|}{\begin{tabular}[c]{@{}c@{}}Fastest for payload \\ \textgreater 500 byte\end{tabular}}                & \multicolumn{1}{c|}{}             & \multicolumn{1}{c|}{X}            & \multicolumn{1}{c|}{\begin{tabular}[c]{@{}c@{}}On average 0,2 s faster\\ for payload \textgreater 600 byte\end{tabular}}    &  \\ \cline{1-4}
\multicolumn{1}{|c|}{\begin{tabular}[c]{@{}c@{}}Average time {[}seconds{]} \\ to send 200 bytes payload\end{tabular}}     & \multicolumn{1}{c|}{0,66}         & \multicolumn{1}{c|}{1,00}         & \multicolumn{1}{c|}{}                                                                                                       &  \\ \cline{1-4}
\multicolumn{1}{|c|}{\begin{tabular}[c]{@{}c@{}}Average time {[}seconds{]}\\  to send 700 bytes payload\end{tabular}}     & \multicolumn{1}{c|}{1,35}         & \multicolumn{1}{c|}{1,15}         & \multicolumn{1}{c|}{}                                                                                                       &  \\ \cline{1-4}
\multicolumn{1}{|c|}{\begin{tabular}[c]{@{}c@{}}Highest measured \\ goodput {[}bytes{]} \\ per second\end{tabular}}       & \multicolumn{1}{c|}{554}          & \multicolumn{1}{c|}{642}          & \multicolumn{1}{c|}{}                                                                                                       &  \\ \cline{1-4}
\multicolumn{1}{|c|}{\begin{tabular}[c]{@{}c@{}}Overall best stability\\ in the network\end{tabular}}                     & \multicolumn{1}{c|}{X}            & \multicolumn{1}{c|}{}             & \multicolumn{1}{c|}{}                                                                                                       &  \\ \cline{1-4}
\multicolumn{1}{|c|}{\begin{tabular}[c]{@{}c@{}}Assumed lowest \\ power concumption\end{tabular}}                         & \multicolumn{1}{c|}{}             & \multicolumn{1}{c|}{X}            & \multicolumn{1}{c|}{}                                                                                                       &  \\ \cline{1-4}
