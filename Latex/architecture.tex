...
When the system starts, these modules will be automatically loaded. After this it is possible to use the \textit{hcitool} command. This is a tool designed to connect and keep track of connected devices, both through standard bluetooth and \gls{ble}. 
...
%\begin{itemize}
%  \item 5V    -- VIN		\tab  	Power source, \textbf{\textcolor{green}{green cable}} in Figure \ref{fig:nrf-adxl345}
%  \item GND -- GND 		\tab 	Ground, \textbf{\textcolor{red}{red cable}} in Figure \ref{fig:nrf-adxl345}
%  \item P0.27 -- SDA	\tab	\gls{i2c} Serial Data Line, \textbf{\textcolor{orange}{orange cable}} in Figure \ref{fig:nrf-adxl345}
%  \item P0.26 -- SCL	\tab 	\gls{i2c} Serial Clock Line, \textbf{\textcolor{brown}{brown cable}} in Figure \ref{fig:nrf-adxl345}
%\end{itemize} 
